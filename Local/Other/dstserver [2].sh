...
Menu(){
    ...
    do
        ...
        echo -e "\e[33m作者：Ariwori(i@wqlin.com) 更新地址==>https://wqlin.com/files/dst/\e[0m"
...
Update_script(){
    info "正在检查脚本是否有更新 ..."
    wget https://wqlin.com/files/dst/dstserver.sh -O /tmp/dstserver.sh -o /tmp/dstupdate.log
...
Install_Game(){
    ...
    ./steamcmd.sh +login "anonymous" +force_install_dir "${dst_server_dir}" +app_update "343050"  $beta_str validate +quit
}
